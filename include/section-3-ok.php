...
if (mysqli_num_rows($result) > 0) {
 	...
 	while($row = mysqli_fetch_assoc($result)) {
		...
		<a id='<?php $id_page = "20"; ?>' class="raleway cuatrocientos clean-list list-height x-small grey-text margin-li-section-3" href="documentation.php?id='<?php echo $id_page; ?>' "><?php echo $title; ?><br /></a>
